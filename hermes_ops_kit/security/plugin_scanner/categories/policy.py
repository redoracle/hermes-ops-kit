    ...
    try:
        result = subprocess.run(
            [
                ...
                "--quiet",
                "--exclude",
                ".venv,venv,__pycache__,node_modules,.git,.tox",
            ],
            capture_output=True,
            text=True,
            timeout=30,
...
def run(
    ...
    *,
    ...
    skip_dirs = {
        ...
        ".github",
        "__pycache__",
        ".obsidian-mcp-vault",  # vault MCP search index (gitignored, never shipped)
        "node_modules",
        ".venv",
        "venv",
        ".tox",
    ...
    _skip_markers = ("security/plugin_scanner/rules/",)
