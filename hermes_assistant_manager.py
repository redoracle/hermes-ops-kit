...
from security.redaction import SECRET_PATTERNS  # pyright: ignore[reportMissingImports]
...
def _ping_assistant(config_path: str, assistant_id: str, timeout: int = 15) -> dict:
    ...
    # Load ~/.hermes/.env into os.environ so endpoint env vars are available
...
def main() -> None:
    ...
    try:
        ...
        if args.command == "list":
            ...
            result = _ping_assistant(config_path, args.assistant_id, timeout=args.timeout)
            _output(
